...
from keras.layers import Lambda, Input, Conv2D, Conv2DTranspose, MaxPooling2D, UpSampling2D, \
    Cropping2D, core, Dropout, normalization, concatenate, Activation
...
class SegmentionModel(ModelBase):
    ...
    def build_model(self):
        ...
        conv1 = normalization.BatchNormalization(epsilon=2e-05, axis=3, momentum=0.9, weights=None,
                                                 beta_initializer='RandomNormal', gamma_initializer='one')(conv1)
